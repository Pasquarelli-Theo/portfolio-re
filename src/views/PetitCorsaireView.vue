...
<template>
  <main class="bg-dark_grey1 text-white">
    <div>
      <div class="absolute inset-0 z-20 flex content-center items-center justify-center font-aesthetic text-gray-900">
        <h1 class="text-8xl">P</h1>
        <h1 class="text-6xl">ETIT</h1>
      ...
      <div class="absolute z-10 ml-80 -mt-96 pl-24">
        <div class="flex">
          ...
          <h3 class="-mt-14 font-aesthetic text-3xl">ETIT</h3>
          <h3 class="-mt-16 ml-2 font-aesthetic text-5xl">C</h3>
          <h3 class="-mt-14 font-aesthetic text-3xl">ORSAIRE</h3>
        </div>
      </div>
      ...
      <div class="flex justify-center">
        <a
          ...
          ><bouton libelle="Découvrir l'illustration" class="mt-20 mb-20"
        /></a>
      </div>
    </div>
  </main>
